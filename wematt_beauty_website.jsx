...
export default function WemattEssentialsSite() {
  return (
    <div className="min-h-screen bg-[#030201] text-white overflow-hidden selection:bg-[#d7a84f] selection:text-black">
      <div className="h-8 border-b border-[#8c641f]/50 bg-black text-[#d7a84f] text-xs tracking-[0.25em] flex items-center justify-center uppercase">Free shipping on orders over $150</div>
